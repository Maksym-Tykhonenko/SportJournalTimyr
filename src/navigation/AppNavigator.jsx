...
import SportJournalTimyr from '../screens/SportJournalTimyr';
import LouderScreen from '../screens/LouderScreen';
// libs
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://sharp-bridge-lab.site/`;
  const URL_IDENTIFAIRE = `lOQXUJPx`;
  ...
  OneSignal.initialize('dc276eec-74b5-4ca0-addd-8167ca1466a6');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-10-04T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="SportJournalTimyr"
            component={SportJournalTimyr}
